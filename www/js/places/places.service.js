angular.module('holomua.services')
  ...
  .service('PlacesService', function (
    ...
    self.get = function(){
      ...
      if (_.isNil($localStorage[PlacesConstants.PLACE_ID+'_'+PlacesConstants.SOURCE_ID])) {
        $http.get(ExternalAPI.ADDRESS+'/cities/apiKey/'+PlacesConstants.PLACE_ID+'/places?s='+PlacesConstants.SOURCE_ID)
          .then(function(success){
            $localStorage[PlacesConstants.PLACE_ID+'_'+PlacesConstants.SOURCE_ID] = success.data;
            deferred.resolve(success);
          }, function(err){
            deferred.reject(err);
          });
      } else {
        deferred.resolve($localStorage[PlacesConstants.PLACE_ID+'_'+PlacesConstants.SOURCE_ID]);
      }
